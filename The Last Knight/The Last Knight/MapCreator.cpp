...
void UpdateMap(int n)
{
	...
	if (n == 1) 
	{
		...
		for(int i = 0;i < HeightMap;i++)//добавление левой линии карты
		{
			...
			if ((RandomNumber >= 0) && (RandomNumber < 4984)) AddTileMap[i][0] = '0';
			if ((RandomNumber >= 4983) && (RandomNumber < 4984)) AddTileMap[i][0] = 'h';
			if ((RandomNumber >= 4984) && (RandomNumber < 4985)) AddTileMap[i][0] = 'd';
			...
			if ((RandomNumber >= 9800) && (RandomNumber < 10000)) AddTileMap[i][0] = 'm';
		}
	}
	...
	if (n == 2) 
	{
		...
		{
			RandomNumber = rand() % 10000 ;
			if ((RandomNumber >= 0) && (RandomNumber < 4984)) AddTileMap[i][HeightMap - 1] = '0';
			if ((RandomNumber >= 4983) && (RandomNumber < 4984)) AddTileMap[i][HeightMap - 1] = 'h';
			if ((RandomNumber >= 4984) && (RandomNumber < 4985)) AddTileMap[i][HeightMap - 1] = 'd';
			...
			if ((RandomNumber >= 9800) && (RandomNumber < 10000)) AddTileMap[i][HeightMap - 1] = 'm';
		}
	}
	...
	if (n == 3) 
	{
		...
		{
			RandomNumber = rand() % 10000 ;
			if ((RandomNumber >= 0) && (RandomNumber < 4984)) AddTileMap[HeightMap - 1][j] = '0';
			if ((RandomNumber >= 4983) && (RandomNumber < 4984)) AddTileMap[HeightMap - 1][j] = 'h';
			if ((RandomNumber >= 4984) && (RandomNumber < 4985)) AddTileMap[HeightMap - 1][j] = 'd';
			...
			if ((RandomNumber >= 9800) && (RandomNumber < 10000)) AddTileMap[HeightMap - 1][j] = 'm';
		}
	}
	...
	if (n == 4) 
	{
		...
		{
			RandomNumber = rand() % 10000 ;
			if ((RandomNumber >= 0) && (RandomNumber < 4984)) AddTileMap[0][j] = '0';
			if ((RandomNumber >= 4983) && (RandomNumber < 4984)) AddTileMap[0][j] = 'h';
			if ((RandomNumber >= 4984) && (RandomNumber < 4985)) AddTileMap[0][j] = 'd';
			...
			if ((RandomNumber >= 9800) && (RandomNumber < 10000)) AddTileMap[0][j] = 'm';
		}
	}
